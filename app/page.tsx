      ...
      <header className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-description">
            ...
            disfrutar del campo y compartir
            momentos especiales.
          </p>
      ...
      <section className="intro-section">
        <div className="intro-inner">
          ...
          <p className="intro-text">
            Reservá una estadía para disfrutar
            de la tranquilidad del campo o
            elegí una fecha para realizar tu
            evento.
          </p>
        ...
        <div className="booking-container">
          ...
          <div className="booking-heading">
            ...
            <div>
              ...
              <h2>
                Elegí cómo querés disfrutar
                la chacra
              </h2>

              <p>
                Seleccioná el tipo de reserva
                y después elegí la fecha en el
                calendario.
              </p>
            </div>
            ...
            {mode === 'stay' ? (
              ...
              <>
                ...
                <div>
                  ...
                  <p>
                    Una fecha exclusiva
                    para tu evento. Modalidad
                    masiva, sin límite de 8
                    personas.
                  </p>
          ...
          <div className="reservation-notes">
            ...
            <div>
              ...
              <div>
                ...
                <p>
                  Modalidad masiva y
                  reserva de una única fecha.
                  No se aplica el límite de
                  personas de las estadías.
                </p>
              </div>
            </div>
            ...
            selection.end && (
              ...
              <div className="reservation-form-section">
                ...
                <div className="form-heading">
                  ...
                  <p>
                    Revisá las fechas
                    seleccionadas y completá
                    la información para enviar
                    tu solicitud.
                  </p>
          ...
          <div className="information-grid">
            ...
            <article>
              ...
              <p>
                ...
                recibirás los datos necesarios
                para realizar la seña.
              </p>
